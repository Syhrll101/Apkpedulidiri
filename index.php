                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p>Masukan Nik Dan Nama Lengkap !</p>
                                    </div>
                                    <form class="user" method="post" action="proses_login.php">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="nama_lengkap" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Masukan Nama Lengkap !..."required>
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-user btn-block">Login<i class="fa fa-key"></i> 
                                        </button>
                                        <hr>
