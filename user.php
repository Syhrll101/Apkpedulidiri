    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h3><b>Aplikasi Peduli Diri - Catatan Perjalanan</b></h3>
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-4 text-gray-800">
                        ...
                        if(!empty($url)){
                            ...
                            echo "<h1><p align=center><b>Selamat Datang Di Aplikasi Peduli Diri.</b></p></h1><br><br>";
                            echo "<h6>Anda Login Sebagai : </h6>";
                            echo "<h1><b><i>".$_SESSION['nama_lengkap']."</i></b></h1>";                        }
                        ?>
                </div>
                <!-- /.container-fluid -->
